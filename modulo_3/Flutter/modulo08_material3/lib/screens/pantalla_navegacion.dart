  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        // CAMBIO: Se actualizó el color del indicador al tono terciario
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) => Card(
        child: ListTile(
          ...
          onTap: () {
            // Acción simulada al tocar un servidor
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Abriendo detalles de prod-web-0${i + 1}')),
            );
          },
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          // Variación automática de color según el contenedor semántico
          ...
          child: ListTile(
            ...
            onTap: () {
              // Comportamiento interactivo para las pruebas dinámicas
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Alerta gestionada: [${alerta.nivel}] en ${alerta.servidor}'),
                  backgroundColor: esCritico ? cs.error : cs.tertiary,
                ),
              );
            },
