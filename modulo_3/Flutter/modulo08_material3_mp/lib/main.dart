...
class AppIdiomas extends StatefulWidget {
  const AppIdiomas({super.key});
  @override
  State<AppIdiomas> createState() => _AppIdiomasState();
}

class _AppIdiomasState extends State<AppIdiomas> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.translate, size: 64, color: cs.primary),
            ...
            Text(
              'Nivel B2 · Progreso 68% completado',
