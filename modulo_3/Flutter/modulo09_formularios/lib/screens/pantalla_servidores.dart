...
class _PantallaServidoresState extends State<PantallaServidores> {
  // Se agregaron diferentes nombres al parámetro 'servicio' de cada servidor
  final _servidores = [
    ServidorSSH(
      id: '1', 
      nombre: 'prod-web-01',  
    ...
    ServidorSSH(
      ...
      so: 'Debian 12',    
      ssl: true,
      servicio: 'postgresql', // <-- Cambiado a postgresql
    ),
    ServidorSSH(
      id: '3', 
      nombre: 'staging-api',  
    ...
    ServidorSSH(
      ...
      so: 'Alpine Linux', 
      ssl: false,
      servicio: 'mongo', // <-- Cambiado a mongo
    ),
  ];
