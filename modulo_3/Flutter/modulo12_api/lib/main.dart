...
import 'pantalla_paso1_user.dart';   // ← Paso 1 (mini-ejercicio usuario)
import 'pantalla_paso2.dart';   // ← Paso 2
import 'pantalla_paso2_user.dart';   // ← Paso 2 (mini-ejercicio usuario)
...
final _router = GoRouter(
  ...
  routes: [
    ...
    // Paso 1 User (mini-ejercicio: navega por ID)
    ...
    // Paso 2 User → reemplaza por PantallaPaso2User()
  ...
  Widget build(BuildContext context) {
    const pasos = [
      ...
      _PasoInfo(
        ...
        detalle: 'StatefulWidget · navegación por ID (Anterior / Siguiente)',
