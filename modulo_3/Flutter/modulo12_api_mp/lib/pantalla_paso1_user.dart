...
class PantallaPaso1User extends StatefulWidget {
  const PantallaPaso1User({super.key});

  @override
  State<PantallaPaso1User> createState() => _PantallaPaso1UserState();
}

class _PantallaPaso1UserState extends State<PantallaPaso1User> {
  int _id = 1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paso 1 · Mini-ejercicio (Lección)'),
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'ID: ${ejercicio['id']}  ·  Módulo: ${ejercicio['userId']}',
                          style:
                        ...
                        Chip(
                          label: Text(
                            completado ? 'Lección completada ✓' : 'Lección en progreso',
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Lección anterior'),
